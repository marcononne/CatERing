    ...
    public static void main(String[] args) throws UseCaseLogicException {
        if(CatERing.getInstance().getUserManager().fakeLogin("Alessandro")) {
            ...
            try {
                ...
                System.out.println("\n\t--About to revoke task " + suppliTask.getId() + "--");
                CatERing.getInstance().getTaskManager().revokeTask(suppliTask, suppliTask.getShift(), Optional.empty());
                System.out.println("\tShift: " + suppliTask.getShift());

                System.out.println("\n\t--About to revoke task " + pizzaTask.getId() + "--");
                CatERing.getInstance().getTaskManager().revokeTask(pizzaTask, pizzaTask.getShift(), Optional.ofNullable(pizzaTask.getCook()));
                System.out.println("\tCook: " + pizzaTask.getCook());
                System.out.println("\tShift: " + pizzaTask.getShift());

                System.out.println("\n\n\t--Tasks in the current summary sheet after revoking: --");
                for(Task t: CatERing.getInstance().getTaskManager().getCurrentSheet().getTasks()) {
                    System.out.println(t.toString());
                }
